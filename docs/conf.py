...
# -*- coding: utf-8 -*-
"""
Independence documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'Independence'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import Independence  # noqa
...
project = u'Independence'
_full_version = Independence.__version__
author = Independence.__author__
copyright = Independence.__copyright__
...
htmlhelp_basename = 'Independence-doc'
...
latex_documents = [
    (master_doc, 'Independence.tex', u'Independence Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'Independence', 'Independence Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Independence', 'Independence Documentation',
     author, 'Independence', Independence.__descr__,
     'Miscellaneous'),
]
